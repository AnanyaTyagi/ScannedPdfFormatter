# #!/usr/bin/env python3
# # TagPikePDFFinal.py
# # Build a valid PDF structure tree from your promoted/tags JSON,
# # write invisible (transparent) text at each bbox for clickable-tag
# # highlighting, set real metadata (Title) and create real bookmarks.
#
# import os, sys, json
# import pikepdf
...
#
#     # (optional) XMP â€” safe to keep if you already had it
...
#         gs[Name.ca] = 0.0  # fill alpha
#         gs[Name.CA] = 0.0  # stroke alpha
...
#         part_el[Name.K] = kids
#
#         # tag everything as given (H1/H2/P/â€¦ + FigureCaptionCandidate, etc.)
#         next_mcid = 0
#         for t in tags:
